...
.fixed-bottom-wrapper img {
	...
	<form style="padding: 8px" action="<?php $_SERVER['REQUEST_URI']?>"
		method="POST">
		<fieldset>
...
?>
		<div style="text-align: center">
					<input type="radio" id="pup" name="classification" value="pup"
						checked> <label for="pup">Pup</label> <input type="radio"
						id="weanling" name="classification" value="weanling"> <label
						for="weanling">Weanling</label> <input type="radio" id="breeder"
						name="classification" value="breeder"> <label for="breeder">Breeder</label>
				</div>
				<center>
					<table>
						<tr>
						...
						<tr>
							...
							<td>DOB:*</td>
							<td><input type="date" name="dob" placeholder="mm/dd/yyyy"></td>

							<td>Wean Date:</td>
							<td><input type="date" name="weanDate" placeholder="mm/dd/yyyy">
							</td>
						...
						<tr>
							<td>Tag #:</td>
							<td><input type="text" name="tagNum" placeholder="Tag #"></td>
							<td>Tag Date:</td>
							<td><input type="date" name="tagDate" placeholder="Tag Date"></td>
							<td>Sex:*</td>
							<td><select name="sex">
						...
						<?php getDropDown("genotype_name", "genotypes", "") ?>
							...
							<!-- litter for future use -->
							<td><select name="litter" hidden>
						<?php getDropDown("litterID", "litters", "") ?>
					</select></td>
							<td><input type="checkbox" name="transfer"> <label for="transfer">Transferred</label>
								<input type="checkbox" name="deceased" value="true"> <label
								for="deceased">Deceased</label></td>
						</tr>
					</table>
			...
			<div>
				<table class="table3">
					<tr>
						<td>Comments:</td>
						<td><textarea id="commentBox" name="commentBox" rows="5" cols="33"></textarea>
						</td>
